...
exports.default = exports.WordViewComponent = exports.CharComponent = void 0;

var _charsAccordance = _interopRequireDefault(require("../assets/chars-accordance.json"));
...
class WordViewComponent {
  constructor(allCharacters = [], index = 0, language = 'english', classes = {
    char: '',
    word: ''
  }) {
...
exports.WordViewComponent = WordViewComponent;

class MultiWordViewComponent {
  constructor(allCharacters = [], index = 0, language = 'english', classes = {
    char: '',
    word: ''
  }) {
...
exports.default = MultiWordViewComponent;